...
class allClass extends Component{
    ...
    render(){
        ...
        const ddt=this.state.loaded?(
            <div>
            <Switch>
                {/* <Route path="/offers" component={()=><Offer count={this.state.item.length} data={this.state.data.offers.offer} board={this.state.data.offers.board}/>}/> OFERTAS DE CACA QUITAR*/}
